...
import 'produce_list3_model.dart';
export 'produce_list3_model.dart';

class ProduceList3Widget extends StatefulWidget {
  const ProduceList3Widget({Key? key}) : super(key: key);

  @override
  _ProduceList3WidgetState createState() => _ProduceList3WidgetState();
}

class _ProduceList3WidgetState extends State<ProduceList3Widget> {
  late ProduceList3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProduceList3Model());
  }
