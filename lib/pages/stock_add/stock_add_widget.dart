...
export 'stock_add_model.dart';

class StockAddWidget extends StatefulWidget {
  const StockAddWidget({
    Key? key,
  ...
  @override
  _StockAddWidgetState createState() => _StockAddWidgetState();
}

class _StockAddWidgetState extends State<StockAddWidget> {
  late StockAddModel _model;
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            stockAddStockRecord.stockImage,
